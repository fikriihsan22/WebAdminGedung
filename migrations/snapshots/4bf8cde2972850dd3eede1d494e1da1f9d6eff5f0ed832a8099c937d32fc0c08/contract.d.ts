...
export type StorageHash =
  StorageHashBase<'4bf8cde2972850dd3eede1d494e1da1f9d6eff5f0ed832a8099c937d32fc0c08'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Event: {
      ...
      readonly session: CodecTypes['pg/text@1']['output'];
      readonly dpAmount: CodecTypes['pg/int4@1']['output'];
      readonly remainingAmount: CodecTypes['pg/int4@1']['output'];
    ...
    readonly User: {
      ...
      readonly role: 'SUPER_ADMIN' | 'BUILDING_ADMIN';
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Event: {
      ...
      readonly session: CodecTypes['pg/text@1']['input'];
      readonly dpAmount: CodecTypes['pg/int4@1']['input'];
      readonly remainingAmount: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            readonly UserRole: {
              ...
              readonly values: readonly ['SUPER_ADMIN', 'BUILDING_ADMIN'];
            };
          };
        };
      };
          ...
          readonly Event: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly dpAmount: { readonly column: 'dpAmount' };
